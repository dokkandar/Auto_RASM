...
CATEGORIES = [
    {
        ...
        "rows": [
            ...
            ["RS_Spline",        "Spline",          "deferred", "NURBS — deferred indefinitely per project decision (heavy math, no concrete user need)"],
            ...
            ["RS_Image",         "RasterImage",     "missing",  "Not in current roadmap; sketched in Dobject_Properties.md"],
            ["RS_Solid (2D)",    "Solid2D",         "missing",  "Sketched only"],
            ["RS_Leader",        "Leader",          "missing",  "Sketched only"],
            ["LC_MLeader",       "MLeader",         "missing",  "Sketched only"],
            ["LC_Tolerance",     "Tolerance",       "missing",  "Sketched only"],
            ["RS_ConstructionLine", "Xline / Ray",  "missing",  "Sketched only"],
            ["LC_Hyperbola, LC_Parabola, LC_Rect", "—", "missing", "LibreCAD-specific extensions; not on roadmap"],
